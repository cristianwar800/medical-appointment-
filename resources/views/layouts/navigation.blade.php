...
</nav> por esta <!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Dashboard - Mi Proyecto Médico</title>
...
<div class="container">
    <div class="dashboard-content">
        <h2 class="font-weight-bold text-gray-800">Dashboard</h2>
        <p class="text-gray-700">¡Estás conectado!</p>
    </div>
</div>
