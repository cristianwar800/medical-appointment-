        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto align-items-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="http://localhost:8084/appointments">Citas para Pacientes</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="http://localhost:8082/payment">Método de Pago</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="http://localhost:8086/chat">Chatbox sobre la aplicacion</a>
                    </li>
                    @if(auth()->check())
